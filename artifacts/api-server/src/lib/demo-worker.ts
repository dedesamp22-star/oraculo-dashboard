      ...
      try {
        ...
        demoStore.recordWorkerDiagnostic({
          ...
          adminPayload: {
            ...
            decision: { status, rawDecision: signal.decision, direction: analysis.suggestedDirection, score: analysis.score, signalKey: analysis.signalKey },
            ...
            score: { raw: analysis.diagnostics.rawScore, final: analysis.score, items: analysis.scoreItems },
