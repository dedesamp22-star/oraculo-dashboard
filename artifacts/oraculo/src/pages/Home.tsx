...
import { AuthenticatedTradingDashboard } from '../components/AuthenticatedTradingDashboard';
...
export default function Home() {
  ...
  return (
    <AuthenticatedTradingDashboard
      ...
      onTvIntervalChange={setTvInterval}
      market={market}
      apiHealth={apiHealth}
      radar={radar}
      demoSession={demoSession}
      demoEnabled={demoEnabled}
      demoServerError={demoServerError}
      safeLimited={safeLimited}
      safeReason={safeReason}
      maxDailyTrades={maxDailyTrades}
      demoAutoState={demoAutoState}
      demoAgents={demoAgents}
      mobileOpenTrades={mobileOpenTrades}
      mobilePricesByPair={mobilePricesByPair}
      mobileAuditEntries={mobileAuditEntries}
      mobileAuditLoading={mobileAuditLoading}
      mobileAuditError={mobileAuditError}
      activeTradeCurrentPrice={activeTradeCurrentPrice}
      ...
      onConfiguredBalanceChange={setConfiguredBalance}
    />
  );
}
